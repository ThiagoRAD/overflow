...
const Header = ({children}) => {
  ...
  return (
    <header className="flex text-white items-center space-between">
      <div className="gap-4 p-4 text-sm flex items-end text-[8px]"> {stageSize} of {totalTasks} tasks<span className="text-gray-400 flex items-center"> ({dailyTasks} <RiRepeatLine /> --- {cyclicTasks} <AiOutlineClockCircle/></span> </div>
